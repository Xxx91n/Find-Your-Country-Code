# Handoff 08 — 阶段 B：失效驱动修复

> Cycle-6 | 票：`issues/08-phase-b-failure-fixes.md` | 覆盖 A-xxx：**A-031 · A-032**
...
**完成定义:** issue 全部验收项勾销并各附 commit sha（只读验证命令 + 输出摘要）；报告落 `research/window-reports/08-phase-b-failure-fixes-report.md`；版本控制遵循 WORKFLOW §4.2。
