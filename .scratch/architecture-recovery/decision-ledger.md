...
> 结算结果：A-026…A-035 = **10/10 implemented**（A-026 按 D-010 修订后口径）；**A-036 = current（未结算）**——归并行票 12（W6），本收口票不承载、不代签。
