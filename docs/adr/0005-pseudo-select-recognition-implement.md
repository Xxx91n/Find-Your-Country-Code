...
状态：accepted（实现范围 = 登记 + 手动召唤；自动注入与填充策略归票 18 二次裁决 —— 2026-09-17 二次裁决＝**维持**，见文末 Notes） | 日期：2026-09-05 | 来源：票 17 逐库取证（research/pseudo-select-forensics.md + research/pseudo-select-samples/）
